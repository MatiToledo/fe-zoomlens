...
import { useAllFlowContingency } from "@/hooks/backoffice/treasury/central/flow/contingency";
...
export default function TableTreasuryCentralFlowContingency() {
  const [rowSelected, setRowSelected] = useState<FlowContingency | null>(null);
